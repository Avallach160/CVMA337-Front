'use strict';
/*!
copy of the one in the bower components to comment out the url:url push.
this stops the propogation of event clicking and redirecting within the same window
this files also not in fullcalendar bower.json so it doesnt get auto added to the index
 */
